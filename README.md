...
| 3279116 | long 16 GPU, 4 nodes x 22 min, 1300 steps (submission series) | running |
| 3279461 | ZeRO-2 (DeepSpeed) 4 GPU, micro 3 x accum 4, 150 steps: launcher equivalence check | queued; last submission before the pause |
