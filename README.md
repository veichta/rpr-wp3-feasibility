...
| 3283544 | INFERENCE throughput v2 (`--eval-only --eval-max-batches 0`, contract 448, 400 hard-linked demo copies = 100 samples/GPU, batch 1, 4 GPU), 5:13 wall | forward + loss pass: 197 s active window (1 s DCGM samples) for 100 samples/GPU = 1.97 s/sample = 0.51 samples/s/GPU = 2.03 samples/s/node, 3.6x the training rate; peak 30.7 GB/GPU; GSSR whole-run: GPU start 71% good, GPU util 67-73% acceptable (includes the 85 s startup), FP util 0.31-0.34 good (0.45 over busy ticks), 383 W acceptable |
